...
这个教程是根据 [官方 Rust 教程](https://doc.rust-lang.org/book/index.html) 、视频资料和相关书籍整理而成的 **Rust入门教程** ,章节结构顺序基本参照官方教程,但融入了合理的调整和补充,以减轻学习难度.某些章节也加入了知识点的补充和个人理解.你可以独立阅读此教程,也可以配合官方教程使用.
...
- 已完成所有基础知识的整理,可以进行[在线阅读](https://rust8.cn/)
...
> AI 主要负责解答问题、提供补充内容和错误检查，不进行章节内容的直接生成，以便自己更好地理解和把控教程的内容。
...
如果你觉得这个教程对你有帮助,欢迎给它([Rust 八股文](https://github.com/georgetime1970/rust8.cn/))一个 star ⭐,或者分享给更多的 Rust 学习者.如果你想参与改进这个教程,也欢迎提交 [pull request](https://github.com/georgetime1970/rust8.cn/pulls) 来贡献你的想法.
