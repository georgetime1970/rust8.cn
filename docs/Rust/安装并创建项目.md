---
description: 本文介绍 Rust 工具链的安装、项目创建流程及常用命令,适合初学者快速上手.
---
...
1. 前往 [rustup官网](https://rustup.rs/) 下载并运行安装程序
...
在 [Cargo和Crates.io](./Cargo和Crates.io.md) 章节会详细介绍 Cargo 的使用,这里先介绍如何创建项目:
...
| 命令            | 说明                                                     |
| --------------- | -------------------------------------------------------- |
| `cargo test`    | 运行单元测试(详见[自动化测试](./自动化测试.md#运行测试)) |
